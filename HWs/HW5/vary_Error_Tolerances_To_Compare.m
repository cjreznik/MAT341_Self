...
%a)Newton's Method converges faster to the minimum for less accurate tol.
% b) As you increase the accuracy threshold the number of iterations
% decreases however it does not always converge quicker.
% c) You could change the convergence rates if you change the ICS.